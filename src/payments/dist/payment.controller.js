...
var PaymentController = /** @class */ (function () {
    ...
    PaymentController.prototype.initiate = function (req, dto) {
        return __awaiter(this, void 0, void 0, function () {
            var ownerId;
            return __generator(this, function (_a) {
                ownerId = req.user.id;
                return [2 /*return*/, this.paymentService.initiatePayment(ownerId, dto.amount)];
            });
        });
    };
    PaymentController.prototype.callback = function (clickpayData) {
        return this.paymentService.handleCallback(clickpayData);
    };
    PaymentController.prototype.verify = function (tranRef) {
    ...
    ], PaymentController.prototype, "initiate");
    __decorate([
        common_1.Post('callback'),
        __param(0, common_1.Body())
    ], PaymentController.prototype, "callback");
    __decorate([
        common_1.Get('verify'),
        __param(0, common_1.Query('tran_ref'))
    ], PaymentController.prototype, "verify");
