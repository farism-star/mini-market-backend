...
var ConversationService = /** @class */ (function () {
    function ConversationService(prisma) {
        this.prisma = prisma;
    }
    ConversationService.prototype.createConversation = function (user1, user2) {
        return __awaiter(this, void 0, void 0, function () {
            var conversation, otherUserId, otherUser;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (user1 === user2) {
                            throw new common_1.ConflictException('Users is The Same');
                        }
                    ...
                    case 2:
                        ...
                        _a.label = 3;
                    case 3:
                        otherUserId = conversation.users.find(function (id) { return id !== user1; });
    ...
    ConversationService.prototype.getConversationById = function (conversationId) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.prisma.conversation.findUnique({
