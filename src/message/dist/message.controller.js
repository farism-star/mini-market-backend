...
var MessageController = /** @class */ (function () {
    ...
    MessageController.prototype.getMessages = function (conversationId, page, limit) {
        return __awaiter(this, void 0, void 0, function () {
            var pageNum, limitNum;
            return __generator(this, function (_a) {
                pageNum = parseInt(page) || 1;
                limitNum = parseInt(limit) || 20;
                return [2 /*return*/, this.messageService.getMessages(conversationId, pageNum, limitNum)];
            });
        });
    };
    __decorate([
