...
var SocketGateway = /** @class */ (function () {
    ...
    SocketGateway.prototype.sendMessage = function (data, client) {
        return __awaiter(this, void 0, void 0, function () {
            var imageUrl, voiceUrl, matches, ext, rawExt, fileName, filePath, base64Data, matches, ext, fileName, filePath, base64Data, message, conversation, receiverId, notificationBody, room, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 5, , 6]);
                    ...
                    case 1:
                        message = _a.sent();
                        return [4 /*yield*/, this.prisma.conversation.findUnique({
                                where: { id: data.conversationId },
                                select: { users: true }
                            })];
                    case 2:
                        conversation = _a.sent();
                        receiverId = conversation === null || conversation === void 0 ? void 0 : conversation.users.find(function (id) { return id !== data.senderId; });
                        if (!receiverId) return [3 /*break*/, 4];
                        notificationBody = 'You have received a new message';
                        if (data.type === send_message_dto_1.MessageType.TEXT && data.text) {
                            notificationBody = data.text;
                        }
                        else if (data.type === send_message_dto_1.MessageType.IMAGE) {
                            notificationBody = 'You have received an image message';
                        }
                        else if (data.type === send_message_dto_1.MessageType.VOICE) {
