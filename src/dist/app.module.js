...
var AppModule = /** @class */ (function () {
    ...
    AppModule.prototype.configure = function (consumer) {
        consumer
            ...
            .exclude({ path: 'v1/auth/login', method: common_1.RequestMethod.POST }, { path: 'v1/auth/admin/owners', method: common_1.RequestMethod.GET }, { path: 'v1/auth/admin/clients', method: common_1.RequestMethod.GET }, { path: 'v1/auth/admin/markets', method: common_1.RequestMethod.GET }, { path: 'v1/auth/register', method: common_1.RequestMethod.POST }, { path: 'v1/auth/admin/login', method: common_1.RequestMethod.POST }, { path: 'v1/auth/add-admin', method: common_1.RequestMethod.POST }, { path: 'v1/auth/delete-users', method: common_1.RequestMethod.DELETE }, { path: 'v1/messages/delete-all', method: common_1.RequestMethod.DELETE }, { path: 'v1/auth/delete-all-data', method: common_1.RequestMethod.DELETE }, { path: 'v1/orders/delete-all', method: common_1.RequestMethod.DELETE }, { path: 'v1/auth/verify-otp', method: common_1.RequestMethod.POST }, { path: 'v1/twilio/send-sms', method: common_1.RequestMethod.POST }, { path: 'uploads/(.*)', method: common_1.RequestMethod.GET })
            .forRoutes('*');
    };
